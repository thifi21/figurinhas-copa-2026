...
export const SECTIONS: Section[] = [
  ...
  { id: 'CUW', name: 'Curaçao', count: 20, confederation: 'CONCACAF', colors: ["#002B7F","#FFFFFF","#FEDA00"], flag: '🇨🇼', group: 'E', page: 44 },
  { id: 'ECU', name: 'Equador', count: 20, confederation: 'CONMEBOL', colors: ["#FFD100","#003893","#ED1C24"], flag: '🇪🇨', group: 'E', page: 46 },
  { id: 'NED', name: 'Holanda', count: 20, confederation: 'UEFA', colors: ["#FF6600","#FFFFFF","#21468B"], flag: '🇳🇱', group: 'F', page: 48 },
  { id: 'JPN', name: 'Japão', count: 20, confederation: 'AFC', colors: ["#FFFFFF","#BC002D","#1B1B1B"], flag: '🇯🇵', group: 'F', page: 50 },
  { id: 'SWE', name: 'Suécia', count: 20, confederation: 'UEFA', colors: ["#005B99","#FECC02","#1B1B1B"], flag: '🇸🇪', group: 'F', page: 52 },
  { id: 'TUN', name: 'Tunísia', count: 20, confederation: 'CAF', colors: ["#E70013","#FFFFFF","#1B3A8B"], flag: '🇹🇳', group: 'F', page: 54 },
  { id: 'BEL', name: 'Bélgica', count: 20, confederation: 'UEFA', colors: ["#000000","#FFD700","#EF3340"], flag: '🇧🇪', group: 'G', page: 56 },
  { id: 'EGY', name: 'Egito', count: 20, confederation: 'CAF', colors: ["#CE1126","#FFFFFF","#000000"], flag: '🇪🇬', group: 'G', page: 58 },
  { id: 'IRN', name: 'Irã', count: 20, confederation: 'AFC', colors: ["#239F40","#FFFFFF","#DA0000"], flag: '🇮🇷', group: 'G', page: 60 },
  { id: 'NZL', name: 'Nova Zelândia', count: 20, confederation: 'OFC', colors: ["#FFFFFF","#00247D","#CC142B"], flag: '🇳🇿', group: 'G', page: 62 },
  { id: 'ESP', name: 'Espanha', count: 20, confederation: 'UEFA', colors: ["#C60B1E","#FFC400","#1B1B1B"], flag: '🇪🇸', group: 'H', page: 64 },
  { id: 'CPV', name: 'Cabo Verde', count: 20, confederation: 'CAF', colors: ["#003893","#FFFFFF","#CF2027"], flag: '🇨🇻', group: 'H', page: 66 },
  { id: 'KSA', name: 'Arábia Saudita', count: 20, confederation: 'AFC', colors: ["#006C35","#FFFFFF","#1E3A2B"], flag: '🇸🇦', group: 'H', page: 68 },
  ...
  { id: 'SEN', name: 'Senegal', count: 20, confederation: 'CAF', colors: ["#00853F","#FDEF42","#E31B23"], flag: '🇸🇳', group: 'I', page: 74 },
  { id: 'IRQ', name: 'Iraque', count: 20, confederation: 'AFC', colors: ["#CE1126","#FFFFFF","#007B3A"], flag: '🇮🇶', group: 'I', page: 76 },
